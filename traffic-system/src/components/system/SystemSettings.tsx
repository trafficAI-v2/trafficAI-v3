  ...
  return (
    <div className="settings-container">
      ...
      <div className="settings-section">
        ...
        <div className="form-grid">
          <div className="form-group">
            <label>系統名稱</label>
            <input type="text" defaultValue="Traffic AI 智慧交通執法系統" />
          </div>
          <div className="form-group">
            <label>系統版本</label>
            <input type="text" value="v2.1.0 (開發中)" readOnly />
          </div>
          <div className="form-group">
            <label>系統語言</label>
          ...
          <div className="form-group switch-group">
            ...
            <div className="switch-wrapper">
              ...
              <label htmlFor="maintenance-switch"></label>
          ...
          <div className="form-group switch-group">
            ...
            <div className="switch-wrapper">
              ...
              <label htmlFor="debug-switch"></label>
              <span>啟用後將記錄更詳細的系統日誌。</span>
            </div>
          </div>
          <div className="form-group slider-group">
            <label>最大同時連線數: 100</label>
            <input type="range" min="10" max="500" defaultValue="100" />
          </div>
          <div className="form-group slider-group">
            <label>工作階段逾時 (分鐘): 30</label>
        ...
        <div className="form-grid">
            ...
            <div className="form-group switch-group">
                ...
                <div className="switch-wrapper">
                    ...
                    <label htmlFor="archive-switch"></label>
                </div>
            </div>
        </div>
        {/* 資料使用統計的部分先用文字表示 */}
      ...
      <div className="settings-section">
        ...
        <div className="form-grid">
          <div className="form-group switch-group">
            <label>電子郵件通知總開關</label>
            <div className="switch-wrapper"><input type="checkbox" id="email-switch" className="switch" defaultChecked /><label htmlFor="email-switch"></label></div>
          </div>
          <div className="form-group switch-group">
            <label>簡訊通知總開關</label>
            <div className="switch-wrapper"><input type="checkbox" id="sms-switch" className="switch" disabled /><label htmlFor="sms-switch"></label></div>
          </div>
          <div className="form-group switch-group">
            <label>LINE 通知總開關</label>
            <div className="switch-wrapper"><input type="checkbox" id="line-switch" className="switch" disabled /><label htmlFor="line-switch"></label></div>
          </div>
          {/* 其他子開關可以未來再加入 */}
        </div>
      </div>
